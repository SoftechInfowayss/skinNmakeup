...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
      {/* Floating Pink Particles Background */}
      ...
      {/* Hero Section with Dark/Pink Theme */}
      <section className="relative py-32 overflow-hidden">
        <motion.div 
          initial={{ scale: 1.1 }}
          animate={{ scale: 1 }}
          transition={{ duration: 1.5, ease: [0.16, 1, 0.3, 1] }}
          className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1586&q=80')] bg-cover bg-center opacity-20"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/90 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-r from-pink-600/20 to-rose-500/20" />
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            >
              <a 
                href="#contact-form" 
                className="bg-gradient-to-r from-pink-600 to-rose-500 hover:from-pink-500 hover:to-rose-400 text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2"
              >
                <Send size={20} />
                Send a Message
              </a>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <motion.div 
              ...
              whileHover="hover"
              className="bg-gray-800 rounded-3xl shadow-xl p-10 border border-gray-700 backdrop-blur-sm relative overflow-hidden"
            >
              {/* Glow effects */}
              <div className="absolute -right-10 -top-10 w-40 h-40 rounded-full bg-pink-500/10 blur-xl"></div>
              <div className="absolute -left-10 -bottom-10 w-60 h-60 rounded-full bg-rose-500/10 blur-xl"></div>
              ...
              <AnimatePresence>
                {submitSuccess && (
                  ...
                  >
                    <div className="p-4 bg-green-900/30 border border-green-800 text-green-300 rounded-lg flex items-center">
              ...
              <form onSubmit={handleSubmit}>
                ...
                >
                  ...
                  <input
                    ...
                    required
                    className="w-full px-5 py-3 rounded-xl border border-gray-700 focus:border-pink-400 focus:ring-2 focus:ring-pink-500/20 transition-all duration-300 bg-gray-700/50 backdrop-blur-sm placeholder-gray-400 text-white"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-gradient-to-r from-pink-600 to-rose-500 hover:from-pink-500 hover:to-rose-400 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center relative overflow-hidden"
                >
                  {/* Button shine effect */}
            ...
            >
              ...
              {[
                {
                  ...
                  bg: "bg-gradient-to-br from-gray-800 to-gray-800/90 border border-gray-700"
                },
                {
                ...
                <motion.div
                  ...
                  whileHover="hover"
                  className={`p-6 rounded-2xl backdrop-blur-sm ${item.bg} shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group`}
                >
                  {/* Hover glow effect */}
              ...
              {/* Social Media with Dark/Pink Theme */}
              <motion.div
                variants={fadeInUp}
                transition={{ delay: 0.6 }}
                className="pt-6"
              >
                <h3 className="font-semibold text-white mb-4">Follow Our Beauty Journey</h3>
                <div className="flex space-x-3">
                  {[
                    { icon: <Instagram size={20} />, color: "bg-gradient-to-br from-pink-600 to-rose-500", hover: "hover:from-pink-500 hover:to-rose-400" },
                    { icon: <Facebook size={20} />, color: "bg-gradient-to-br from-pink-600 to-pink-400", hover: "hover:from-pink-500 hover:to-pink-300" },
                    { icon: <Twitter size={20} />, color: "bg-gradient-to-br from-rose-500 to-pink-400", hover: "hover:from-rose-400 hover:to-pink-300" }
                  ].map((social, i) => (
                    <motion.a
                      key={i}
                      href="#"
                      className={`w-10 h-10 rounded-full flex items-center justify-center text-white ${social.color} ${social.hover} shadow-md transition-all duration-300 relative overflow-hidden`}
                      whileHover={{ 
                        y: -4,
                        scale: 1.1,
      ...
      <section className="py-20 bg-gradient-to-b from-gray-900 to-gray-800">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="overflow-hidden rounded-3xl shadow-2xl border border-gray-700 relative"
          >
            ...
            <iframe 
              ...
              width="100%" 
              height="500" 
              style={{ border: 0, filter: 'grayscale(30%) contrast(120%) brightness(0.7)' }} 
              allowFullScreen="" 
              loading="lazy" 
              referrerPolicy="no-referrer-when-downgrade"
              className="relative z-0"
            />
            <div className="absolute inset-0 pointer-events-none bg-gradient-to-t from-gray-900/50 via-transparent to-transparent z-10" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        {[...Array(10)].map((_, i) => (
          <motion.div
            ...
            className="absolute rounded-full border border-pink-500/20 backdrop-blur-sm"
            style={{
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-pink-200 mb-10 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="bg-gradient-to-r from-pink-600 to-rose-500 hover:from-pink-500 hover:to-rose-400 text-white font-semibold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group"
              >
                {/* Button shine effect */}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="border-2 border-pink-400 text-white font-semibold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group"
              >
                {/* Button shine effect */}
